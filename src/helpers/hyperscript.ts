...
export interface HyperscriptHelperFn {
  (): VNode
  (classNameOrId: string, data: VNodeData, children: string | number | Array<string | VNode | null>): VNode
  (classNameOrId: string, data: VNodeData): VNode
  (classNameOrId: string, children: string | number | Array<string | VNode | null>): VNode
  (classNameOrId: string): VNode
  (data: VNodeData): VNode
  (data: VNodeData, children: string | number | Array<string | VNode | null>): VNode
  (children: string | number | Array<string | VNode | null>): VNode
}
